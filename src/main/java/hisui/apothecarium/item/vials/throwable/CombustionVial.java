...
public class CombustionVial extends VialThrowable {
    public CombustionVial(Settings settings) {
        super(settings);
    }

    public CombustionVial(Settings settings, int color) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ThrownCombustionVialEntity vialEntity = new ThrownCombustionVialEntity(world, user);
