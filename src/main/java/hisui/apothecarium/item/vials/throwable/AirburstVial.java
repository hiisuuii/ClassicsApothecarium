...
import hisui.apothecarium.entity.ThrownAirburstVialEntity;
...
public class AirburstVial extends VialThrowable {
    public AirburstVial(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ThrownAirburstVialEntity vialEntity = new ThrownAirburstVialEntity(world, user);
