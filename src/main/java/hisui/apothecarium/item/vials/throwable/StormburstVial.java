...
import hisui.apothecarium.entity.ThrownStormburstVialEntity;
...
public class StormburstVial extends VialThrowable {
    public StormburstVial(Settings settings) {
        super(settings);
    }

    public StormburstVial(Settings settings, int color) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ThrownStormburstVialEntity vialEntity = new ThrownStormburstVialEntity(world, user);
